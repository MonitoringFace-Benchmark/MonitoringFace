from Infrastructure.DataTypes.Contracts.SubContracts.DataGeneratorContract import data_contract_to_commands
...
class DataGenGenerator(DataGeneratorTemplate):
    ...
    def run_generator(self, contract_inner, time_on=None, time_out=None):
        ...
        inner_contract[COMMAND_KEY] = (["java", "-cp", "classes:libs/*", "org.entry.Dispatcher", "Generator"]
                                     + data_contract_to_commands(contract_inner))
