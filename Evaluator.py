    ...
    def __init__(self):
        ...
        monitor_manager = MonitorManager(
            ...
            monitors_to_build=[
                ...
                ("EnfGuard", "EnfGuard", "enfguard", {"replayer": "gen_data", "path_to_build": path_to_build})
            ]
        )
        ...
        res = benchmark.run(monitor_manager.get_monitors(["TimelyMon 1", "TimelyMon 6", "VeriMon", "MonPoly", "EnfGuard"]), {})
        print(res)
